...
const SubNav: React.FC<SubNavProps> = ({ selectedCategory, onCategoryClick }) => {
  ...
  return (
    <div className="sticky top-16 z-40 bg-rental-off-white/90 backdrop-blur-md border-b border-gray-200">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm transition-colors duration-200 border whitespace-nowrap ${
                  selectedCategory === 'all'
                    ? 'bg-rental-dark text-white border-rental-dark'
                    : 'bg-white text-gray-700 border-gray-300 hover:border-rental-dark'
                }`}
              >
                All
              </button>
